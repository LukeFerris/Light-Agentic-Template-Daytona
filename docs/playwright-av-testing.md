...
- **Playwright video recording** — `video: 'on'` (which this template already
  sets) records the whole page to `test-results/`. You can hand that file to a
  model, or extract frames from it.
